...
export default function IdCard() {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between space-y-6 lg:space-y-0 lg:px-6">
      <div className="relative lg:w-[550px] w-[420px] lg:h-80 h-60 shadow-5xl backdrop-filter backdrop-blur-sm border-l border-t border-gray-100/30 bg-white/10 p-6 rounded-xl">
      ...
      <div className="lg:w-[550px] w-[420px] lg:h-80 h-60 shadow-5xl backdrop-filter backdrop-blur-sm border-l border-t border-gray-100/30 bg-white/10 py-6 rounded-xl">
