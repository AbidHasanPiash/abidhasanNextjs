...
export default function BtnTwoSideGlow({text, link }) {
  return (
    ...
    <div className='w-36 h-12 relative group'>
      ...
      <button className='w-full h-full text-lg font-bold overflow-hidden backdrop-filter backdrop-blur-[15px] hover:tracking-widest duration-200 rounded-full border-t border-b border-gray-200/30
