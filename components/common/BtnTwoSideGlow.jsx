...
export default function BtnTwoSideGlow({text, link }) {
  return (
    ...
    <div className='h-12 w-fit relative group'>
      ...
      <button className='w-full h-full px-6 text-lg font-bold overflow-hidden backdrop-filter backdrop-blur-[15px] 
        hover:tracking-widest duration-200 rounded-full border-t border-b border-gray-200/30
        before:block before:absolute before:left-0 before:top-0 before:w-1/2 before:h-full 
        before:bg-gradient-to-r from-transparent to-white/20
        before:skew-x-[45deg] before:translate-x-0 before:duration-300 before:hover:translate-x-[110%]
        hover:text-white'>
        {text}
      </button>
    </div>
