...
export default function BtnTwoSideGlow({text}) {
  return (
    <div className='w-36 h-12 relative group'>
      <div className='w-10 h-3 -z-0 bg-[#c0f] rounded-md absolute -bottom-1 left-1/2 transform -translate-x-1/2 duration-300
        group-hover:bottom-0 group-hover:delay-75 group-hover:rounded-full group-hover:w-9/12 group-hover:h-1/2'/>
      <div className='w-10 h-3 -z-0 bg-[#c0f] rounded-md absolute -top-1 left-1/2 transform -translate-x-1/2 duration-300
